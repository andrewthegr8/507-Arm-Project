...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, Motor_Enable_Pin|Motor_Sleep_Pin|Motor_6_Reset_Pin|Motor_5_Reset_Pin
  ...
  /*Configure GPIO pins : Motor_4_Reset_Pin MP1_NINT_Pin Motor_2_Reset_Pin */
  GPIO_InitStruct.Pin = Motor_4_Reset_Pin|MP1_NINT_Pin|Motor_2_Reset_Pin;
  ...
  /*Configure GPIO pins : MP2_NINT_Pin PB8 */
  GPIO_InitStruct.Pin = MP2_NINT_Pin|GPIO_PIN_8;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : MP_CLK_Pin */
  GPIO_InitStruct.Pin = MP_CLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.Alternate = GPIO_AF0_MCO;
  HAL_GPIO_Init(MP_CLK_GPIO_Port, &GPIO_InitStruct);

  /*AnalogSwitch Config */
  HAL_SYSCFG_AnalogSwitchConfig(SYSCFG_SWITCH_PC2, SYSCFG_SWITCH_PC2_CLOSE);

  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(MP1_NINT_EXTI_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(MP1_NINT_EXTI_IRQn);
